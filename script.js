...
document.addEventListener("DOMContentLoaded", function() {
  ...
  resetActiveCards();
  const firstCard = cardsContainer.querySelector(".card:first-child");
  if (firstCard) {
    firstCard.classList.add("active");
  }
  
  // Handle card clicks - active card navigates to URL
  cardsContainer.addEventListener("click", (e) => {
    const target = e.target.closest(".card");
    
    if (!target) return;
    
    // If card has a URL, navigate to it
  ...
  document.getElementById('theme-button').addEventListener('click', function () {
    ...
    if (body.classList.contains('light-mode')) {
      ...
      particles.style.backgroundColor = 'black';
      ...
      particles.style.backgroundColor = 'white';
